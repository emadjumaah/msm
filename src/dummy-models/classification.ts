...
const INTENT_KEYWORDS: Record<string, string[]> = {
  place_order: ["order", "want", "get", "buy", "need", "i want"],
  track_order: [
    "where",
    "track",
    "status",
  ...
  cancel: ["cancel", "stop", "remove", "delete", "nevermind", "cancel my"],
  inquiry: ["how", "what", "price", "cost", "menu", "available", "how much"],
  complaint: ["problem", "wrong", "bad", "late", "missing", "broken"],
...
const DOMAIN_KEYWORDS: Record<string, string[]> = {
  ...
  retail: ["buy", "product", "item", "shipping", "return", "store"],
  support: ["help", "problem", "issue", "complaint", "service"],
};
